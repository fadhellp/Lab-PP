class Human:
    def __init__(self, name, position):
        self.name = name
        self.__pos_x = position  #private klo dua __
    ...
    def setMovement (self, move):
        ...
        if move == 'R':
            self.__pos_x += self._speed #krena dua yg apakn kt bkin kan kondisi di soal hrus menerima r dan l 
    
class Hero (Human):
    def __init__(self, name, pos_x):
        super().__init__(name, pos_x)  #super itu memanggil method yg kita definisikan di parent class
        self._power = 15
        self._health = 400
        self._armor = 15
        self._speed = 3
