...
a = print(" a. Detail Anda ")
b = print(" b. Ubah Nama ")
c = print(" c. Jumlah Data Pada File ")
d = print(" d. Save Data Pada File ")
e = print(" e. Buat Data Baru ")
f = print(" f. Keluar ")

x = input("Silahkan Pilih Opsi Anda :")


if x == a:
    print("data anda kosong")import os
import re
